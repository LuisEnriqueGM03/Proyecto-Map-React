...
const Dashboard = () => {
    return (
        <>
            ...
            <Container className="d-flex flex-column justify-content-center align-items-center" style={{ height: '120vh' }}>
                <h1 className="mb-5 text-center">Dashboard Administrador</h1>

                <Row className="justify-content-center" style={{ width: '100%' }}>
                    
                    <Col md={6} lg={4} className="mb-4">
                        <Link to="/usuarioslista" className="text-decoration-none">
                            <Card className="text-center fold" style={{ height: '300px', cursor: 'pointer' }}>
                                <Card.Body className="d-flex flex-column justify-content-between">
                                    <Card.Title className={"title"}>Gestión de Usuarios</Card.Title>
                                    <i className="fas fa-users fa-8x mb-5"></i>
                                </Card.Body>
                            </Card>
                        </Link>
                    </Col>
                    ...
                    <Col md={6} lg={4} className="mb-4">
                        <Link to="/tiposincidentes" className="text-decoration-none">
                            <Card className="text-center fold" style={{ height: '300px', cursor: 'pointer' }}>
                                <Card.Body className="d-flex flex-column justify-content-between">
                                    <Card.Title className={"title"}>Tipos de Incidentes</Card.Title>
                                    <i className="fas fa-list-ul fa-8x mb-5"></i>
                                </Card.Body>
                            </Card>
                        </Link>
                    </Col>
                    ...
                    <Col md={6} lg={4} className="mb-4">
                        <Link to="/Historial" className="text-decoration-none">
                            <Card className="text-center fold" style={{ height: '300px', cursor: 'pointer' }}>
                                <Card.Body className="d-flex flex-column justify-content-between">
                                    <Card.Title className={"title"}>Historial de Cambios</Card.Title>
                                    <i className="fas fa-history fa-8x mb-5"></i>
                                </Card.Body>
                            </Card>
                        </Link>
                    </Col>
